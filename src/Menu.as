package
{
	...
	public class Menu extends Sprite
	{
		...
		private function drawScreen():void
		{
			...
			ciudadArriba = new Image(Assets.getAtlas("CiudadesYTitulo").getTexture("Ciudad2-01"));
			ciudadArriba.x = 0;
			ciudadArriba.y = 0;
			ciudadArriba.touchable = false;
			
			ciudadAbajo = new Image(Assets.getAtlas("CiudadesYTitulo").getTexture("Ciudad3-01"));
			ciudadAbajo.x = 1280;
			ciudadAbajo.y = 720;
			...
			botonSingle = new BotonMejorado(Assets.getAtlas("CiudadesYTitulo").getTexture("UnJugadorDesac"), "", Assets.getAtlas("CiudadesYTitulo").getTexture("UnJugadorActivo"), true);
			botonSingle.x = 270;
			botonSingle.y = 0;
			botonSingle.touchable = false;
			
			botonMultiplayer = new BotonMejorado(Assets.getAtlas("CiudadesYTitulo").getTexture("MultijugadorDesac"), "", Assets.getAtlas("CiudadesYTitulo").getTexture("MultijugadorActivo"), true);
